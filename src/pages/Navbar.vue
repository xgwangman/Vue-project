<template>
    <div class="navbar">
        ...
        <section class="scroll-list">
            <travel key="index" v-for="(item,index) in travelsList" :travel="item" v-show="initIndex == 0"></travel>
            <panel key="index" v-for="(item,index) in sportsList" :sport="item" v-show="initIndex == 1"></panel>
        </section>
